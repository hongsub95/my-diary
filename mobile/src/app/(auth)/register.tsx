...
const createStyles = (palette: ThemePalette) => StyleSheet.create({
  ...
  description: { color: colors.muted, fontSize: 14, marginBottom: spacing.lg, marginTop: spacing.sm },
  label: { color: colors.text, fontSize: 14, fontWeight: '600', marginBottom: spacing.sm, marginTop: spacing.md },
  input: { backgroundColor: colors.surface, borderColor: colors.border, borderRadius: 14, borderWidth: 1, color: colors.text, fontSize: 14, paddingHorizontal: spacing.md, paddingVertical: 15 },
  ...
  consentTitle: { color: colors.muted, fontSize: 14, fontWeight: '600' },
  ...
  checkMark: { color: '#FFFFFF', fontSize: 13, fontWeight: '600' },
