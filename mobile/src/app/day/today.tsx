...
const createStyles = (palette: ThemePalette) => StyleSheet.create({
  ...
  headerEyebrow: { color: palette.primaryDark, fontSize: 14, fontWeight: '600' },
  headerTitle: { color: colors.text, fontSize: 18, fontWeight: '600', marginTop: 2 },
  content: { padding: spacing.lg, paddingBottom: 60 },
  live: { color: colors.sage, fontSize: 14, fontWeight: '600', letterSpacing: 1.1 },
  ...
  eyebrow: { color: palette.primaryDark, fontSize: 14, fontWeight: '600', letterSpacing: 1.1 },
  ...
  photoLabel: { bottom: 14, color: '#FFFFFF', fontSize: 14, fontWeight: '600', position: 'absolute', right: 15 },
  nextCopy: { padding: 18 },
  nextTitle: { color: colors.text, fontSize: 16, fontWeight: '600', marginTop: 4 },
  ...
  flowCopy: { flex: 1 },
  flowName: { color: colors.text, fontSize: 14, fontWeight: '600' },
  flowMemo: { color: colors.muted, fontSize: 9, marginTop: 3 },
  nextBadge: { backgroundColor: palette.primarySoft, borderRadius: 10, color: palette.primaryDark, fontSize: 14, fontWeight: '600', overflow: 'hidden', paddingHorizontal: 7, paddingVertical: 4 },
  ...
  photoActionTitle: { color: '#FFFFFF', fontSize: 14, fontWeight: '600' },
